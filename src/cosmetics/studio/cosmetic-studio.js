      ...
      <div style="display:grid;grid-template-columns:180px minmax(300px,1fr) 300px;gap:14px;min-height:0;flex:1;padding:14px;">
        ...
        <aside style="border:0.5px solid var(--border);border-radius:9px;padding:10px;display:flex;flex-direction:column;gap:8px;min-height:0;overflow:auto;">
          <div style="display:flex;justify-content:center;align-items:center;padding:8px;border:0.5px solid var(--border);border-radius:7px;background:repeating-conic-gradient(#20252a 0 25%,#171b1f 0 50%) 0/16px 16px;">
            <canvas id="studioCanvas" width="${isSkin ? 256 : 256}" height="${isSkin ? 256 : 128}" aria-label="${skin ? '64 by 64 skin texture editor' : '64 by 32 cape texture editor'}" style="display:block;max-width:100%;height:auto;image-rendering:pixelated;image-rendering:crisp-edges;cursor:crosshair;"></canvas>
          </div>
